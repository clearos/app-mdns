...
class Mdns extends ClearOS_Controller
{
    /**
	...
	//$views = array('mdns/server', 'mdns/settings');
	$views = array('mdns/server');

        $this->page->view_forms($views, lang('mdns_app_name'));
        ...
        $this->page->view_form('mdns/summary', $data, lang('mdns_app_name'));
    }
